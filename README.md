...
<body>
    <style>
        body{
            background: linear-gradient(-105deg, blue, yellow, green);
            height: 100vh;
        }
        p{
            font-size: 25px;
    ...
    <h1>A História da Copa do Mundo</h1><br>

    <p>
    <img src="https://www.cnnbrasil.com.br/wp-content/uploads/sites/12/2022/06/GettyImages-892454.jpg?w=876&h=484&crop=1" width="45%" align="left"> 
    ...
    As seleções da Europa que aceitaram tiveram de viajar de navio por um período de dois meses.</p> 
